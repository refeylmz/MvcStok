...
namespace MvcStok.Controllers
{
    public class MusteriController : Controller
    {
        ...
        {
            if (!ModelState.IsValid) // bu if blogu 
            {
            ...
            // --> return RedirectToAction("Index", "Musteri"); bu şekilde de post işleminden sonra müşterileri listelettiğimiz sayfaya yönlendirebiliriz
        }

        //------------------------- MÜŞTERİ SİLME İŞLEMLERİ --------------------------------
